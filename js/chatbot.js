...
const DESTINOS = {
  ...
  'sacaba':                    { label:'Aparcamiento SACABA',         lat:36.6803, lng:-4.4485 },
  'parking sacaba':            { label:'Aparcamiento SACABA',         lat:36.6803, lng:-4.4485 },
  'manuel alvar':              { label:'Aparcamiento SACABA',         lat:36.6803, lng:-4.4485 },
  'av manuel alvar':           { label:'Aparcamiento SACABA',         lat:36.6803, lng:-4.4485 },
  'avenida manuel alvar':      { label:'Aparcamiento SACABA',         lat:36.6803, lng:-4.4485 },
  'playa sacaba':              { label:'Playa de Sacaba',             lat:36.6803, lng:-4.4485 },
  'playa de sacaba':           { label:'Playa de Sacaba',             lat:36.6803, lng:-4.4485 },
  'misericordia':              { label:'Playa de la Misericordia',    lat:36.6803, lng:-4.4485 },
  'playa misericordia':        { label:'Playa de la Misericordia',    lat:36.6803, lng:-4.4485 },
  'playa de la misericordia':  { label:'Playa de la Misericordia',    lat:36.6803, lng:-4.4485 },
